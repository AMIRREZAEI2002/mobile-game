...
let srartgameis = document.getElementById('srartgameis');
...
function toleftfunc() {
    leftPosition -= 25; // کاهش موقعیت left به اندازه 10 پیکسل
...
function startgamefunc(){
    ...
    palneis.style.display = "block"
    palneis.style.left = "50%"
...
//فرایند های شروع بازی
srartgameis.addEventListener('touchend',startgamefunc)
